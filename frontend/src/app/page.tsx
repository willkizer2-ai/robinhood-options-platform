...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-bg-base">
      ...
      {/* ── Tab navigation ── */}
      <div className="sticky top-[57px] z-40 border-b border-border-dim bg-bg-base/97 backdrop-blur-md">
      ...
      <main className="mx-auto max-w-screen-2xl px-4 py-5 pb-12">
        ...
        <div className={cn('tab-panel', activeTab === 'signals' ? 'block' : 'hidden')}>
          {/* Compact stats strip */}
          {trades && (
            <div className="mb-4 flex flex-wrap items-center gap-x-5 gap-y-2 rounded-lg border border-border-dim bg-bg-card px-4 py-2.5 text-xs">
