...
> ⚠️ **START WITH `CODE-MANAGER-REWORK-GUIDE.md`.** That file is the step-by-step
> plan to rebuild the live site (the first attempt only applied dark colors; all the
> old Market Cyclops UI is still there). This file is just a map of what's in the
> package.
