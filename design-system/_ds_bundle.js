...
function PerformanceScreen() {
  ...
  }, "Performance populates once real trade history is connected."));
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "No monthly data available.") : /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'flex-end',
      gap: 14,
    ...
    const up = mo.r >= 0;
    const h = Math.abs(mo.r) / max * 130 + 6;
    return /*#__PURE__*/React.createElement("div", {
      key: i,
      style: {
        flex: 1,
  ...
  }, "Past performance is not indicative of future results. Figures shown are backtested.")));
}
...
function Desk() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "main"
  }, tab === 'signals' && /*#__PURE__*/React.createElement(SignalsScreen, null), tab === 'performance' && /*#__PURE__*/React.createElement(PerformanceScreen, null), tab === 'research' && /*#__PURE__*/React.createElement(ResearchScreen, null), tab === 'alerts' && /*#__PURE__*/React.createElement(AlertsScreen, null), tab === 'news' && /*#__PURE__*/React.createElement(NewsScreen, null)));
}
